...
// CRIAÇÃO DO OBJETO "PERFIL CANDIDATO"
const candidato = {
    nome: 'Tânia FONSECA',
    area: 'FrontEnd',
    habilidades: ['JavaScript', 'HTML', 'CSS', 'Github', 'lógica de programação', 'Kanban'],
    experienciaMeses: 12
}
// APRESENTAÇÃO DO CANDIDATO
console.log('Nome do/da candidato/a: ' + candidato.nome +
    '\nÁrea: ' + candidato.area +
...
// CRIAÇÃO DE CLASSE FILHA: HERANÇA DE ATRIBUTOS
...
// APRESENTAÇÃO DAS VAGAS INDEXADAS
...
let expeCandidato = candidato.experienciaMeses
console.log(expeCandidato)
// function nivelCandidato(expeCandidato){
//     if (expeCandidato <= 48) return "Junior"
//     if (expeCandidato =< 48) > 48 && candidato.experienciaMeses <= 120) return "Pleno"
//     if (expeCandidato > 120) return "Sênior"
// }
// nivelCandidato()
